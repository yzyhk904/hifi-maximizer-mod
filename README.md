...
* Tips: If you use "AirMusic" to transmit audio data, I recommend to set around 4523 msec additional delay to reduce jitter distortion on the AirMusic panel to display target device(s).
